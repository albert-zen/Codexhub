import type { MessageMode, WorkerSessionStatus } from "@codexhub/core";
...
interface SessionActionAvailabilityInput {
...
function sendStatusReason(
  ...
  if (canSend(status, action)) return null;
...
function isTerminalStatus(status: WorkerSessionStatus): boolean {
